...
% TESTAR PDI
% Calib.Imagem.Atual = rgb2hsv(imresize(imread('img13.png'),Cam.Redimensionar,'bicubic'));
% Calib.Imagem.Atual = rgb2hsv(Cam.Video.snapshot);
Calib.Imagem.Atual = rgb2hsv(getsnapshot(Cam.Video));
