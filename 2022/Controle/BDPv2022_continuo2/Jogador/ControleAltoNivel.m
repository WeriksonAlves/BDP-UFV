...
% if norm(rBDP.pPos.Xtil(1:2)) < 30
% % 
rBDP.pPos.dXd = (rBDP.pPos.Xd - rBDP.pPos.Xa)*0.1; 
k1 = 1.1;%1
k2 = 5;%5 
...
A = [rBDP.pPos.dXd(1) + k1*(1-exp(-k2* (norm(rBDP.pPos.Xtil(1:2)))))*rBDP.pPos.Xtil(1);% matriz de controle
    rBDP.pPos.dXd(2) + k1*(1-exp(-k2* norm(rBDP.pPos.Xtil(1:2))))*rBDP.pPos.Xtil(2)];% matriz de controle
