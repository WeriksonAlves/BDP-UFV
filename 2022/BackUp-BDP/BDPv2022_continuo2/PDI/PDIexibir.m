...
if Bola.Status == 1
    Bola2.idCAD.Vertices = ([1 0 Bola2.X(1); 0 1 Bola2.X(2); 0 0 1]*Bola2.CAD)';
else
    Bola2.idCAD.Vertices = ([0 0 0; 0 0 0; 0 0 0]*Bola2.CAD)';

end
 Bola3.idCAD.Vertices = ([1 0 Bola3.X(1); 0 1 Bola3.X(2); 0 0 1]*Bola3.CAD)';
    
     
%     Bola.idCAD.Vertices = ([1 0 Bola2.X(1); 0 1 Bola2.X(2); 0 0 1]*Bola.CAD)';
