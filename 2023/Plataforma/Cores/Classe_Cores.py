...
class JanelaCores(object):
    ...
    def Criar_Janela(self):
        ...
        self.Janela.minsize(940, 700)
        self.Janela.maxsize(940, 700)
    ...
    def Criar_CheckButton(self):
        ...
        Chebut_Vermelho.place(height=50, width=120, x=0, y=0)
        ...
        Chebut_Laranja.place(height=50, width=120, x=120, y=0)
        ...
        Chebut_Amarelo.place(height=50, width=120, x=240, y=0)
        ...
        Chebut_Verde.place(height=50, width=120, x=360, y=0)
        ...
        Chebut_Ciano.place(height=50, width=120, x=480, y=0)
        ...
        Chebut_Azul.place(height=50, width=120, x=600, y=0)
        ...
        Chebut_Cinza.place(height=50, width=120, x=840, y=0)
    ...
    def Criar_TextoInformacao(self):
        ...
        Txt_Matriz.place(height=30, width=50, x=180, y=60)

        Txt_Saturacao = Label(self.Janela, text="Saturação", bg='#229A00')
        Txt_Saturacao.place(height=30, width=60, x=470, y=60)

        Txt_Luminosidade = Label(self.Janela, text="Luminosidade", bg='#229A00')
        Txt_Luminosidade.place(height=30, width=80, x=750, y=60)

        Txt_CampoSegmentado = Label(self.Janela, text="Campo Segmentado", bg='#229A00')
        Txt_CampoSegmentado.place(height=20, width=120, x=15, y=270)

        self.Txt_Rotulo = Label(self.Janela)
        self.Txt_Rotulo.place(height=300, width=800, x=70, y=300)
    ...
    def Criar_Escala(self):
        ...
        self.Sca_B1.place(height=70, width=200, x=690, y=85)

        self.VarM6 = IntVar()
        self.Sca_B2 = Scale(self.Janela, from_=0, to=255, orient="horizontal", variable=self.VarM6, bg='#229A00')
        self.Sca_B2.place(height=70, width=200, x=690, y=120)
    ...
    def Comando_HSV(self):
        try:
            ...
            self.Var_Frames = cv2.resize(self.Var_Frames, (400, 300))
            self.Var_AplicacaoCor = cv2.resize(self.Var_AplicacaoCor, (400, 300))
