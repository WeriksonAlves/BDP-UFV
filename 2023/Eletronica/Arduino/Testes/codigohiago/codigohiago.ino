...
#define STBY A0      //Define o pino do standby
#define ENABLE1 5    //Pino do PWM A do motor ESQUERDO
#define ENABLE2 6    //Pino do PWM B do motor DIREITO
#define MOTORET 3    //Pino do motor esquerdo trás AIN2
#define MOTOREF 2    //Pino do motor esquerdo frente AIN1
#define MOTORDT 7    //Pino do motor direito trásdigitalWrite (abc, HIGH) BIN1
#define MOTORDF 4    //Pino do motor direito frentedigitalWrite (abc, HIGH) BIN2
...
void setup() {
  ...
  digitalWrite(STBY, HIGH); //Liga o pino de standby
...
void EsquerdaFrente(int speed){
  analogWrite(ENABLE1, map(speed, 150, 250, 0, 255));
  digitalWrite(MOTOREF, HIGH);
  digitalWrite(MOTORET, LOW);
}

void EsquerdaTras(int speed){
  analogWrite(ENABLE1, map(speed, 149, 50, 0, 255));
...
void DireitaFrente(int speed){
  analogWrite(ENABLE2, map(speed, 150, 250, 0, 255));
...
void DireitaTras(int speed){
  analogWrite(ENABLE2, map(speed, 149, 50, 0, 255));
