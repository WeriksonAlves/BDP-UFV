...
class GameWindow(object):
    ...
    def Command_SaveSettings(self): # Voltar aqui depois
        ...
        if ((-1 in Matrix)==False) and ((self.Var_Cyan_Team.get()==True) or (self.Var_Yellow_Team.get()==True)) and ((self.Var_Left_Attack.get()==True) or (self.Var_Right_Attack.get()==True)):
            ...
            np.savetxt('ConfiguraçõesJogadores.txt',self.Var_Game_Settings)
    ...
    def Command_LoadSettings(self):
        try:
            self.Var_Game_Settings = np.loadtxt(self.Current_Folder+'\Game_Settings.txt')
        ...
        try:
            ...
            if self.Var_Comunication == False:
                ...
                while True:
                    ...
                    if t > tsim:
                        self.pArduino.write([1, 2, int(0), int(0), int(0), int(0), 150, 150, 3, 10])
    ...
    def Game_Action(self):
        # P1 = MY_TEAM(self.Var_MyTeam_Color_BGR,self.Colors_Shirts_BGR[0][0:],self.Var_AttackSide,self.Var_P1_Function.current())
        # P2 = MY_TEAM(self.Var_MyTeam_Color_BGR,self.Colors_Shirts_BGR[1][0:],self.Var_AttackSide,self.Var_P2_Function.current())
        # P3 = MY_TEAM(self.Var_MyTeam_Color_BGR,self.Colors_Shirts_BGR[2][0:],self.Var_AttackSide,self.Var_P3_Function.current())
        ...
        try:
            self.pArduino.write([1, 2, int(self.P1.rBDP_pSC_PWM[0,0]), int(self.P1.rBDP_pSC_PWM[1,0]), int(self.P2.rBDP_pSC_PWM[0,0]), int(self.P2.rBDP_pSC_PWM[1,0]), int(self.P3.rBDP_pSC_PWM[0,0]), int(self.P3.rBDP_pSC_PWM[1,0]), 3, 10])
