...
class App_BDP:
    ...
    def Command_LoadSettings(self):
        try:
            self.Var_MatrixColor = np.loadtxt(self.Current_Folder+'\Cores\MatriZHSV.txt')
            self.Var_PTM = np.loadtxt(self.Current_Folder+'\Campo\MatrizTransformação.txt')
    ...
    def Command_OpenWindowColors(self):
        try:
            ...
            self.WindowColors = JanelaCores(self.Var_Kernel,self.Var_MedianBlur,self.Var_MatrixColor,self.Var_CamInfo,self.Var_FPS)
    ...
    def Command_OpenGameWindow(self):
        # try:
            ...
            self.WindowGame = JanelaPDI(self.Var_MatrixColor,self.Var_CamInfo,self.Var_FPS,self.Var_Kernel,self.Var_MedianBlur,self.Var_PTM,self.juiz)
