...
class JanelaPDI(object):
    def __init__(self, MatrizCor, InformacoesCamera, FPS, Kernel, MedianBlur, MatrizTransfPerspectiva,Juiz):
        """
    ...
    def Criar_Botoes(self):
        ...
        But_Joystick = Button(self.Janela, text="Ativar joystick", command=lambda: threading.Thread(target=self.Comando_joystick).start())
        ...
        # But_Sistema = Button(self.Janela, text="Ativar Sistema", command=lambda: threading.Thread(target=self.Comando_joystick).start())
